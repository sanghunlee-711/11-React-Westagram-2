...
import Like from '../MainLike/Like';
...
addReply = () => {
  ...
  render() {
    const { id, content1, content2, content3, profileImg, mainImg } = this.props;
    ...
    return (    
      <div className="contentMainContainer">
                ...
                <div className="mainHeaderIcon">
                    <a href="https://www.instagram.com/539_ku/" className="userPage">
                        <div className="userIcon">
                            <img alt="" style={{background: `url(${profileImg}) no-repeat center / 100%`}} />
                        </div>
                    </a>
                </div>
                <div className="mainHeaderRight">
                    <div className="mainHeaderId">{id}</div>
            ...
            <div className="contentMainImg" style={{background: `url(${mainImg}) no-repeat center / 100%`}}></div>
                ...
                <div className="mainTextContainer">
                    <div className="mainTextContainerWrap">
                        <div className="mainTextUserComment">
                            <a href="https://www.instagram.com/539_ku/?hl=ko" className="userCommentId">{id}</a>
